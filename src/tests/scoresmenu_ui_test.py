...
class TestHighscoresMenuUI(unittest.TestCase):
    def setUp(self):
        ...
        self.profile1 = profile_manager.Profile(1, "TestUser", {"1": 4, "2": 6})
        self.profile2 = profile_manager.Profile(2, "TestUser2", {"1": 5, "2": 4})
    ...
    def test_doesnt_return_level_int_if_not_clicked(self):
        self.assertEqual(self.logic.select_level((100, 390), self.profile1), None)

    def test_returns_to_main_menu(self):
        self.assertEqual(self.logic.get_selected_level((440, 1075), self.profile1), ("MAINMENU", True, None))

    def test_returns_correct_level_info(self):
        self.assertEqual(self.logic.get_selected_level((260, 390), self.profile1), ("MAINMENU", False, 1))
